...
<body class="<?php print $classes; ?>">
	...
	<div id="header" class="container">
		<div class="span-8"><h2 id="logo"><a href="<?php print $base_path; ?>">Sarah Ashraf</a></h2></div>
		<div class="span-10 last prepend-6">
			<?php print theme(
				array('links__system_main_menu', 'links'), 
				$primary_links, 
				array('id' => 'nav')
			);
            ?>
	...
	<div id="content" class="container">
		...
		<div class="span-6">
			<?php print $home_first; ?>
		</div>
		
		<div class="span-6">
			<?php print $home_second; ?>
		</div>
		
		<div class="span-6">
			<?php/* print $home_third;*/ ?>
			
			<div id="right-now" class="blockMod span-6">
				<h3>Right Now</h3>
				<?php echo twitter(); ?>
			</div>
		</div>
